...
const (
	FavoriteService_AddFavorite_FullMethodName    = "/shortterm.favorite.v1.FavoriteService/AddFavorite"
	FavoriteService_RemoveFavorite_FullMethodName = "/shortterm.favorite.v1.FavoriteService/RemoveFavorite"
	FavoriteService_ListFavorites_FullMethodName  = "/shortterm.favorite.v1.FavoriteService/ListFavorites"
	FavoriteService_IsFavorited_FullMethodName    = "/shortterm.favorite.v1.FavoriteService/IsFavorited"
)
...
type FavoriteServiceClient interface {
	...
	IsFavorited(ctx context.Context, in *IsFavoritedRequest, opts ...grpc.CallOption) (*IsFavoritedResponse, error)
}
...
func (c *favoriteServiceClient) IsFavorited(ctx context.Context, in *IsFavoritedRequest, opts ...grpc.CallOption) (*IsFavoritedResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IsFavoritedResponse)
	err := c.cc.Invoke(ctx, FavoriteService_IsFavorited_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FavoriteServiceServer interface {
	...
	IsFavorited(context.Context, *IsFavoritedRequest) (*IsFavoritedResponse, error)
}
...
func (UnimplementedFavoriteServiceServer) IsFavorited(context.Context, *IsFavoritedRequest) (*IsFavoritedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsFavorited not implemented")
}
...
func _FavoriteService_IsFavorited_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsFavoritedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FavoriteServiceServer).IsFavorited(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FavoriteService_IsFavorited_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoriteServiceServer).IsFavorited(ctx, req.(*IsFavoritedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FavoriteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shortterm.favorite.v1.FavoriteService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FavoriteService_IsFavorited_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "shortterm/favorite/v1/favorite.proto",
}
